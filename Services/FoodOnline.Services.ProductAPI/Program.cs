using AutoMapper;
using FoodOnline.Services.ProductAPI;
using FoodOnline.Services.ProductAPI.DBContexts;
using FoodOnline.Services.ProductAPI.Repository;
...
{
    setupAction.SwaggerDoc("v1", new OpenApiInfo { Title = "FoodOnline.Services.ProductAPI", Version = "v1" });
